...
//!
//! `down` restores the previous view text, misbinding included: a rollback must reproduce the
//! schema of the migration state it returns to, not a corrected version of it.
