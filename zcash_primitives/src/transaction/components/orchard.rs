...
///
/// `bundle_version` must be a pre-NU6.3 Orchard version
/// ([`BundleVersion::orchard_insecure_v0`] before NU6.2, [`BundleVersion::orchard_v1`] from
/// NU6.2): both share the v5 flag-byte grammar (bit 2 reserved), and the version's protocol
/// generation selects whether the canonical proof size is enforced.
