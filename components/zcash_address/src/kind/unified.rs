...
pub(crate) mod private {
    ...
    /// each placeholder uses the multipath notation required by `kind`. It does not
    /// validate the template against the full BIP 388 descriptor grammar, nor the key
    /// material itself; that is the responsibility of consumers that interpret the
    /// policy.
    ///
    /// [BIP 388]: https://github.com/bitcoin/bips/blob/master/bip-0388.mediawiki
